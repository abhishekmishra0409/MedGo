            ...
            <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        className="block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm leading-5 text-gray-700 focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500"
                    >
                                    ...
                                    <div className="flex items-start justify-between">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="mt-2 flex flex-wrap gap-2">
                                                    {doctor.specializations?.map((spec, index) => (
                                                        <span key={index} className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-slate-100 text-slate-800">
                                                            {spec}
                                                        </span>
                                                    ))}
                                                </div>
                                        ...
                                        <div className="flex flex-wrap items-center justify-end gap-2">
                                            <select
                                                ...
                                                className="rounded-md border border-gray-300 bg-white px-2 py-1 text-xs font-medium text-gray-700 focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500"
                                            >
                                                {APPROVAL_STATUSES.map((status) => (
                                                    <option key={status} value={status}>
                                                        {status.charAt(0).toUpperCase() + status.slice(1)}
