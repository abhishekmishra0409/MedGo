                ...
                <div className="space-y-4">
                    {filteredBookings?.map((booking) => (
                        <div key={booking._id} className="bg-white rounded-lg shadow overflow-hidden">
                            <div
                                className="p-4 cursor-pointer flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"
                                onClick={() => toggleExpand(booking._id)}
                            >
                                <div className="flex min-w-0 items-center gap-4">
                                    <div className="shrink-0 bg-teal-100 text-teal-800 p-3 rounded-lg">
