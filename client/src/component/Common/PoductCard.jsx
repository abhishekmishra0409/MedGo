    ...
    return (
        ...
        >
            ...
            <div className="absolute top-2 left-2 flex flex-col space-y-2">
                {isHot && <span className="bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full">HOT</span>}
                {isNew && <span className="bg-teal-500 text-white text-xs font-bold px-2 py-1 rounded-full">NEW</span>}
            </div>
            ...
            {/* Product Info */}
            <div className="p-4">
                {category && <p className="text-xs text-teal-600 font-medium mb-1">{category}</p>}
